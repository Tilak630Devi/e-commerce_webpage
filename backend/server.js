// .env example:
// PORT=5000
// MONGODB_URI=mongodb+srv://admin:admin@shop1.2yux4fe.mongodb.net/
// DB_NAME=shopDB
// ADMIN_JWT_SECRET=supersecretadmin
// USER_JWT_SECRET=supersecretuser
// SHOP_WHATSAPP_NUMBER=91XXXXXXXXXX
...
async function ensureDefaultAdmin() {
  ...
  if (!exists) {
    ...
    console.log('⚠️  Default admin user created: username=admin, password=admin (change in production)');
  }
}
