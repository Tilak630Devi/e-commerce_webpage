        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              ...
              At <strong>AAVRA GENERAL</strong>, we believe beauty is for everyone — 
              and our carefully curated collection of products helps you glow with
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <GlassCard className="p-6 text-center space-y-2">
                ...
                <p className="text-gray-700">contact@aavrageneral.com</p>
              </GlassCard>
              <GlassCard className="p-6 text-center space-y-2">
                <h3 className="font-semibold text-pink-600">Instagram</h3>
                <a
                  href="https://instagram.com/aavrageneral"
                  target="_blank"
              ...
              <GlassCard className="p-6 text-center space-y-2">
                ...
                <p className="text-gray-700">Neemuch, Madhya Pradesh</p>
              </GlassCard>
            </div>
          </section>
          ...
          <section className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-gray-600 dark:text-gray-300 mb-6">
              Drop by our store to explore our full collection and get personalized recommendations.
            </p>
