...
export function Navbar() {
  ...
  <div className="flex items-center justify-between px-6 py-4">
    ...
    <div className="flex items-center space-x-4">
      {/* Search Icon */}
      <button className="p-2 gradient-text-pink hover:opacity-80 transition">
  ...
  {isMobileMenuOpen && (
    <div className="md:hidden border-t border-white/20 px-6 py-4 space-y-4 animate-in slide-in-from-top-2">
      ...
      <Link href="/categories" className="block gradient-text-pink font-medium hover:opacity-80 transition" onClick={() => setIsMobileMenuOpen(false)}>Categories</Link>
      ...
      <Link href="/contact" className="block gradient-text-pink font-medium hover:opacity-80 transition" onClick={() => setIsMobileMenuOpen(false)}>Contact</Link>
